...
// Initialize Vonage Video API client - COMMENTED OUT
...
export async function bookAppointment(formData) {
  ...
  try {
    ...
    // Create a new Vonage Video API session - COMMENTED OUT
    // const sessionId = await createVideoSession();

    // Generate a simple call ID for future video integration
    ...
    // Create the appointment with a placeholder video session ID
    const appointment = await db.appointment.create({
      data: {
        ...
        patientDescription,
        status: "SCHEDULED",
        videoSessionId: callId, // Placeholder for future video integration
      },
    });
...
/**
 * Generate a Vonage Video API session - COMMENTED OUT
 */
...
/**
 * Generate a token for a video session - COMMENTED OUT
...
export async function generateVideoToken(formData) {
  ...
  try {
    ...
    throw new Error(
      "Video call feature is currently unavailable. Please check back later."
    );

    // COMMENTED OUT - Original Vonage token generation
